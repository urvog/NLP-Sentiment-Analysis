...
De los resultados obtenidos y a través de una rápida revisión de las predicciones de ambos modelos, se consigue mejores resultados a través del modelo BERT, lo que demuestra su potencia predictiva con pocos datos de entrenamiento, pero a costa de un mayor costo computacional frente a modelos clasicos de CNN.
